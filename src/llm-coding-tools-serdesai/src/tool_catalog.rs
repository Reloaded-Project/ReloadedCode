//! Cloneable tool catalog for serdesAI framework.
//!
...
//!
//! ```no_run
//! use llm_coding_tools_serdesai::{default_tools, TodoState, ToolCatalogEntry};
...
///
/// Exposes tool metadata for registries and enables builder registration.
#[derive(Debug, Clone)]
